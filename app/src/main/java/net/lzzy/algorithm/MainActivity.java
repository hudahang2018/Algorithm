...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initSearch() {
        spSearch = findViewById(R.id.activity_main_sp1);
        spSearch.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item,
                SearchFactory.getSearchNames()));
        container = findViewById(R.id.activity_main_btn_sort);
        findViewById(R.id.activity_main_bt_chazhao).setOnClickListener(new View.OnClickListener() {
            @Override
